...
<x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
        <h2 class="text-2xl font-bold uppercase mb-1"> Edit your Job Post
    ...
    <form action="/listings/{{$listing->id}}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mb-6">
            <label for="location" class="inline-block">Job Location</label>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags" placeholder="Example: Lavarel, Backend, Postgres, etc"  value="{{$listing->tags}}">
            @error('tags')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
        <div class="mb-6">
            ...
            <img src="{{$listing->logo ? asset('storage/' .$listing->logo) : asset('/images/workhubimage.jpg')}}" >
        ...
        <div class="mb-6">
            <button class="bg-laravel text-white rounded py-2 px-4 hover:bg-block">
                Update Gig
            </button>
